 ...
 */
export class RemoteObjectStorage implements IObjectStorage {
    private splitter: string = "/";

    constructor(private readonly dataProvider: HttpDataProvider) { }
    ...
    public async saveChanges(delta: Object): Promise<void> {
        ...
        await this.dataProvider.saveData(storageDataObject);
    }
}
